...
export function renderPaymentSummary() {
    ...
    const priceTax = totalPriceBeforeTax * 0.1
    const totalPriceAfterTax = totalPriceBeforeTax + priceTax
    ...
    const paymentSummaryHTML = `
        ...
        <div class="payment-summary-row">
            ...
            <div class="payment-summary-money">$${formatCurrency(priceTax)}</div>
        </div>
